...
function searchHostels() {
    ...
    filterHostels(searchInput);
}


function filterHostels(searchInput) {
    ...
    var filteredHostels = jsonData.filter(function (hostel) {
        return (!searchInput || hostel.name.toLowerCase().startsWith(searchInput)) &&
...
function resetFilters() {
    ...
    document.getElementById("filterMinVacancy").value = '';
    document.getElementById("filterMessAvailability").value = '';
...
document.getElementById('searchInput').addEventListener('input', searchHostels);
document.getElementById('filterGender').addEventListener('change', searchHostels);
document.getElementById('filterMinVacancy').addEventListener('input', searchHostels);
document.getElementById('filterMessAvailability').addEventListener('change', searchHostels);
